...
public class SharepreferenceBeanDao extends AbstractDao<SharepreferenceBean, Long> {
    ...
    public static class Properties {
        ...
        public final static Property Open_door_num = new Property(1, int.class, "open_door_num", false, "OPEN_DOOR_NUM");
        ...
        public final static Property Open_door_building = new Property(4, int.class, "open_door_building", false, "OPEN_DOOR_BUILDING");
        public final static Property Open_door_unit = new Property(5, int.class, "open_door_unit", false, "OPEN_DOOR_UNIT");
        public final static Property Open_door_params = new Property(6, String.class, "open_door_params", false, "OPEN_DOOR_PARAMS");
    }
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"SHAREPREFERENCE_BEAN\" (" + //
                ...
                "\"OPEN_DOOR_NUM\" INTEGER NOT NULL ," + // 1: open_door_num
                "\"OPEN_DOOR_DIRECTION_ID\" TEXT," + // 2: open_door_direction_id
                "\"OPEN_VILLAGE_ID\" TEXT," + // 3: open_village_id
                "\"OPEN_DOOR_BUILDING\" INTEGER NOT NULL ," + // 4: open_door_building
                "\"OPEN_DOOR_UNIT\" INTEGER NOT NULL ," + // 5: open_door_unit
                "\"OPEN_DOOR_PARAMS\" TEXT);"); // 6: open_door_params
    }
    ...
    protected final void bindValues(DatabaseStatement stmt, SharepreferenceBean entity) {
        ...
        stmt.bindLong(2, entity.getOpen_door_num());
        ...
        stmt.bindLong(5, entity.getOpen_door_building());
        stmt.bindLong(6, entity.getOpen_door_unit());
 
        String open_door_params = entity.getOpen_door_params();
        if (open_door_params != null) {
            stmt.bindString(7, open_door_params);
        }
    }
    ...
    public SharepreferenceBean readEntity(Cursor cursor, int offset) {
        SharepreferenceBean entity = new SharepreferenceBean( //
            ...
            cursor.getInt(offset + 1), // open_door_num
            ...
            cursor.getInt(offset + 4), // open_door_building
            cursor.getInt(offset + 5), // open_door_unit
            cursor.isNull(offset + 6) ? null : cursor.getString(offset + 6) // open_door_params
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, SharepreferenceBean entity, int offset) {
        ...
        entity.setOpen_door_num(cursor.getInt(offset + 1));
        ...
        entity.setOpen_door_building(cursor.getInt(offset + 4));
        entity.setOpen_door_unit(cursor.getInt(offset + 5));
        entity.setOpen_door_params(cursor.isNull(offset + 6) ? null : cursor.getString(offset + 6));
     }
